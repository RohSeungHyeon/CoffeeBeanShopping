			...
			<section class="content">
				...
				<div id="join">
					<form method="post"
						...
						name="joinForm" onsubmit="return checkForm()">
								...
								<tbody>
									<tr>
										...
										<td class="content"><input type="text"
											name="essential.emailId" id="essential.emailId"
											value="<%=idAndDomain[0]%>" readonly />&nbsp;@&nbsp; <input
											type="text" name="essential.emailDomain"
											id="essential.emailDomain" value="<%=idAndDomain[1]%>"
											readonly /> <select name="select_domain" id="select_domain"
											onchange="changeDomain()" disabled>
									...
									<tr>
										...
										<td class="content"><input type="password"
											name="essential.pwd" id="essential.pwd" onkeyup="checkPwd()" />
											<span id="checkresult_policy"></span></td>
									</tr>
									<tr>
										<th class="header">패스워드 확인</th>
										<td class="content"><input type="password"
											name="essential.pwd_confirm" id="essential.pwd_confirm"
											onkeyup="checkPwd()" /> <span id="checkresult_confirm"></span></td>
									</tr>
									<tr>
										<th class="header">사용자 유형</th>
										<td class="content">개인 <input type="radio"
											name="essential.userType" id="essential.userType" value="개인"
											onclick="checkOpenAndHide();" /> 사업자 <input type="radio"
											name="essential.userType" id="essential.userType" value="사업자"
											onclick="checkOpenAndHide();" />
										</td>
									</tr>
									<tr>
										<th class="header">이름</th>
										<td class="content"><input type="text"
											name="essential.name" id="essential.name" value="<%=name%>"
											autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">닉네임</th>
										<td class="content"><input type="text"
											name="essential.nickname" id="essential.nickname"
											value="<%=nickName%>" autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">주소</th>
										<td class="content"><input type="text"
											name="essential.address" id="essential.address"
											autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">연락처</th>
										<td class="content"><input type="text"
											name="essential.phone_head" id="essential.phone_head"
											maxlength="3" style="width: 70px;" autocomplete="off"
											onkeyup="checkPhone(event)" /> - <input type="text"
											name="essential.phone_front" id="essential.phone_front"
											maxlength="4" style="width: 70px;" autocomplete="off"
											onkeyup="checkPhone(event)" /> - <input type="text"
											name="essential.phone_back" id="essential.phone_back"
											maxlength="4" style="width: 70px;" autocomplete="off"
											onkeyup="checkPhone(event)" /></td>
									</tr>
						...
						<div id="join_addtional">
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="content"><select name="optional.gender"
											id="optional.gender">
									...
									<tr>
										...
										<td class="content"><select name="optional.birth_yy"
											id="optional.birth_yy$" style="width: 80px">
												<option value=""></option>
										...
										</select> 년 <select name="optional.birth_mm" id="optional.birth_mm"
											style="width: 60px">
												<option value=""></option>
										...
										</select> 월 <script type="text/javascript">
								...
								for(i = 0; i < select_month.options.length; i++) {
									if(select_month.options[i].value == month)
							...
							</script> <select name="optional.birth_dd" id="optional.birth_dd"
											style="width: 60px">
												<option value=""></option>
												<option value="01">1</option>
												<option value="02">2</option>
										...
										</select> 일 <script type="text/javascript">
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="content"><input type="text"
											name="optional.buyer.name" id="optional.buyer.name"
											autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">사업지 주소</th>
										<td class="content"><input type="text"
											name="optional.buyer.address" id="optional.buyer.address"
											autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">사업지 연락처</th>
										<td class="content"><input type="text"
											name="optional.buyer.phone" id="optional.buyer.phone"
											autocomplete="off" /></td>
									</tr>
									<tr>
										<th class="header">직급</th>
										<td class="content"><input type="text"
											name="optional.buyer.rank" id="optional.buyer.rank"
											autocomplete="off" /></td>
									</tr>
