		...
		<div class="row">
			<h3>Q&A작성</h3>
				<table class="table table-default"
					...
					<tbody>
						<tr>
							<td>작성자<input type="text" class="form-control" placeholder="작성자" name="qnaWriter" maxlength="50" value="${sessionScope.userprofile.nickname }" readonly style="background-color: #eeeeee; text-align: center; "/></td>
						</tr>
						<tr>
