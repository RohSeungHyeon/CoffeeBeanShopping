...
public class ModifyUserInfoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String userPhone = request.getParameter("essential.phone_head") + "-"
				+ request.getParameter("essential.phone_front") + "-" + request.getParameter("essential.phone_back");
		...
		if (service.modifyUserInfo(user, userType)) {
			...
			out.print("<html>");
			out.print("<head>");
			out.print("<script type='text/javascript'>alert('수정되었습니다'); location.href='" + request.getContextPath()
